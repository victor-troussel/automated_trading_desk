...
def get_volume_analysis(timeframe_id, candle_array):
    ...
    try:
        ...
        for lookback_value in VOLUME_LOOKBACK_VALUES:
            if not 'is_biggest_volume_up_50' in previous_candles[0]:
            ...
            print('\033[33m' + '>> ' + str(candle_array[0]["symbol"]) + ' \'s Volume analysis for ' + str(lookback_value) + ' periods on a ' + timeframe_id + ' timeframe added. \033[0m')
